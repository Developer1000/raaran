...
class SubCategoryViewController: UICollectionViewController , UICollectionViewDelegateFlowLayout {
	...
	override func viewWillAppear(animated: Bool) {
		...
		subCategoryDataList =  DataHelper.getSubCategoryList(cateoryName as String)
    ...
    */
	...
	override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
		...
		let subCategoryDetails:NSDictionary = self.subCategoryDataList?.objectAtIndex(indexPath.row) as! NSDictionary
		let subCategoryName = subCategoryDetails.valueForKey(constants.keyMenu) as? String
		cell.title.text = subCategoryName
	...
	override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)
	{
		if segue.identifier == "detail"
		{
			...
			let categoryDetails:NSDictionary = self.subCategoryDataList?.objectAtIndex(indexPath.row) as! NSDictionary
			let vc = segue.destinationViewController as! DetailViewController
			let subCategoryName:NSString = categoryDetails.valueForKey(constants.keyMenu)! as! NSString
			vc.arrImgNames = DataHelper.getDetailListData(cateoryName as String, resuouceName:subCategoryName as String)
